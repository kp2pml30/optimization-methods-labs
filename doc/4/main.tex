...
\begin{itemize}
	...
	\item \MakePlots{x^2 + y^2 - 1.2*x*y}{x^2 + y^2 - \frac{6}{5}xy}{1.2/0/}{\methodsList}{view={-10}{45}}{domain=-4.0:4.0, y domain=-1.0:2.1}
	...
	\item \MakePlots{100*(y-x^2)^2 + (1-x)^2}{100(y-x^2)^2 + (1-x)^2}{1.2/1/}{\methodsList}{view={10}{45}}{domain=-1.6:1.5, y domain=-0.1:2.2}
...
\begin{itemize}
	...
	\item \MakePlots{100(y-x^2)^2 + (1-x)^2}{100(y-x^2)^2 + (1-x)^2}{2/0/0/}{\methodsList}{view={-10}{45}}{domain=0.0:1.5, y domain=-1.5:2.0}
		\csvautotabular[separator=tab]{2/0/iters.tsv}\\
		\csvautotabular[separator=tab]{2/0/last.tsv}\\

\def\secondfunc{(x^2+y-11)^2 + (x+y^2-7)^2}
	\item \MakePlots{\secondfunc}{\secondfunc}{2/1/0/}{\methodsList}{view={10}{45}}{domain=-1:5, y domain=-2.0:3.5} \\
		У функции есть 4 минимума равных нулю, однако минимум $x \approx 3.58443; y \approx -1.84813$ не был найден ни одним из методов.\\
		\begin{tikzpicture}
		\begin{axis}[view={0}{90},xlabel={$x$},ylabel={$y$}]
		\addplot3[surf, shader=interp] {\secondfunc};
		\end{axis}
		\end{tikzpicture}
		\\
		\csvautotabular[separator=tab]{2/1/iters.tsv}\\
		\csvautotabular[separator=tab]{2/1/last.tsv}\\
	\item \MakePlots{100-2/(1+((x-1)/2)^2+((y-1)/3)^2)-1/(1+((x-2)/2)^2+((y-1)/3)^2)}
		...
		\csvautotabular[separator=tab]{2/2/iters.tsv}\\
		\csvautotabular[separator=tab]{2/2/last.tsv}\\
